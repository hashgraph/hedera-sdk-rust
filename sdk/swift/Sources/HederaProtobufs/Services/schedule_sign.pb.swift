...
extension Proto_ScheduleSignTransactionBody: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ScheduleSignTransactionBody"
  ...
  public static func ==(lhs: Proto_ScheduleSignTransactionBody, rhs: Proto_ScheduleSignTransactionBody) -> Bool {
