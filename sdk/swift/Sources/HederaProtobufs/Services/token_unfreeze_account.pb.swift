...
extension Proto_TokenUnfreezeAccountTransactionBody: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TokenUnfreezeAccountTransactionBody"
  ...
  public static func ==(lhs: Proto_TokenUnfreezeAccountTransactionBody, rhs: Proto_TokenUnfreezeAccountTransactionBody) -> Bool {
