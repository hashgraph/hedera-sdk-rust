...
extension Key: TryProtobufCodable {
    ...
    internal init(fromProtobuf proto: Protobuf) throws {
        guard let key = proto.key else {
            throw HError(kind: .fromProtobuf, description: "unexpected empty key in Key")
        }
        ...
        case .rsa3072:
            throw HError(kind: .fromProtobuf, description: "unsupported key kind: Rsa3072")
        case .ecdsa384:
            throw HError(kind: .fromProtobuf, description: "unsupported key kind: Rsa384")
