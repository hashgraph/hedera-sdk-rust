...
public struct TokenAssociation: Codable {
    ...
    public static func fromBytes(_ bytes: Data) throws -> Self {
        let json: String = try bytes.withUnsafeTypedBytes { pointer in
            ...
            try HError.throwing(error: hedera_token_association_from_bytes(pointer.baseAddress, pointer.count, &ptr))
    ...
    private func toBytesInner() throws -> Data {
        ...
        try HError.throwing(error: hedera_token_association_to_bytes(json, &buf, &bufSize))
