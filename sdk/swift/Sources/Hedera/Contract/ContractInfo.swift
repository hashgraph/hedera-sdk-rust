...
public final class ContractInfo: Codable {
    ...
    public static func fromBytes(_ bytes: Data) throws -> Self {
        let json: String = try bytes.withUnsafeTypedBytes { pointer in
            ...
            try HError.throwing(error: hedera_contract_info_from_bytes(pointer.baseAddress, pointer.count, &ptr))
    ...
    private func toBytesInner() throws -> Data {
        ...
        try HError.throwing(error: hedera_contract_info_to_bytes(json, &buf, &bufSize))
