...
//
// Edited by Skyler Ross on 2022/11/14
// summary of edits for reproduction purposes:
// - Renamed the enum to `Status`
// - Removed Protobuf dependencies
// - changed `rawValue` from `Int` to `Int32`
// - various protocols that don't depend on the exact generated code were implemented in a separate file.
//
