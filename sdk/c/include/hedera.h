...
typedef enum HederaError {
  ...
  HEDERA_ERROR_INVALID_ACCOUNT_ID,
  HEDERA_ERROR_ACCOUNT_DELETED,
  HEDERA_ERROR_INVALID_TOKEN_REF,
  HEDERA_ERROR_TOKEN_WAS_DELETED,
  HEDERA_ERROR_TOKEN_ALREADY_ASSOCIATED_TO_ACCOUNT,
  HEDERA_ERROR_TOKENS_PER_ACCOUNT_LIMIT_EXCEEDED,
} HederaError;
