...
impl FromProtobuf<services::CustomFee> for AnyCustomFee {
        ...
        Self: Sized,
    {
        ...
        Ok(Self { fee, fee_collector_account_id, all_collectors_are_exempt: pb.all_collectors_are_exempt})
    }
}
...
impl From<FixedFee> for AnyCustomFee {
    fn from(v: FixedFee) -> Self {
        Self { fee: v.fee.into(), fee_collector_account_id: v.fee_collector_account_id, all_collectors_are_exempt: v.all_collectors_are_exempt }
    }
}
