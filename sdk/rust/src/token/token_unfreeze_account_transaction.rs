...
pub type TokenUnfreezeAccountTransaction = Transaction<TokenUnfreezeAccountTransactionData>;

#[serde_as]
#[skip_serializing_none]
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct TokenUnfreezeAccountTransactionData {
...
impl TokenUnfreezeAccountTransaction {
...
#[async_trait]
impl TransactionExecute for TokenUnfreezeAccountTransactionData {
    async fn execute(
        &self,
        channel: Channel,
...
impl ToTransactionDataProtobuf for TokenUnfreezeAccountTransactionData {
...
impl From<TokenUnfreezeAccountTransactionData> for AnyTransactionData {
    fn from(transaction: TokenUnfreezeAccountTransactionData) -> Self {
