...
impl Display for CustomFee {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        write!(f, "fee_collector_account_id: {}, fee: {}", self.fee_collector_account_id, self.fee)
    }
}
...
impl FromProtobuf for CustomFee {
    ...
    fn from_protobuf(pb: Self::Protobuf) -> crate::Result<Self> {
        ...
        let fee_collector_account_id = AccountId::from_protobuf(pb_getf!(pb, fee_collector_account_id)?)?;
...
impl Display for Fee {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        match self {
            Self::FixedFee(fixed_fee) => Display::fmt(fixed_fee, f),
            Self::FractionalFee(fractional_fee) => Display::fmt(fractional_fee, f),
            Self::RoyaltyFee(royalty_fee) => Display::fmt(royalty_fee, f),
        }
    }
}
...
impl FromProtobuf for Fee {
    ...
    fn from_protobuf(pb: Self::Protobuf) -> crate::Result<Self> {
        match pb {
            Self::Protobuf::FixedFee(fixed_fee) => Ok(Fee::FixedFee(FixedFee::from_protobuf(fixed_fee)?)),
            Self::Protobuf::FractionalFee(fractional_fee) => Ok(Fee::FractionalFee(FractionalFee::from_protobuf(fractional_fee)?)),
            Self::Protobuf::RoyaltyFee(royalty_fee) => Ok(Fee::RoyaltyFee(RoyaltyFee::from_protobuf(royalty_fee)?)),
        }
    }
}
...
impl ToProtobuf for Fee {
    ...
    fn to_protobuf(&self) -> Self::Protobuf {
        match self {
            ...
            Self::FractionalFee(fractional_fee) => Self::Protobuf::FractionalFee(fractional_fee.to_protobuf()),
...
impl FromProtobuf for FractionalFee {
    ...
    fn from_protobuf(pb: Self::Protobuf) -> crate::Result<Self> {
        Ok(Self {
            ...
            fractional_amount: Fraction::from_protobuf(pb_getf!(pb, fractional_amount)?)?,
        })
    }
}
...
impl ToProtobuf for FractionalFee {
    ...
    fn to_protobuf(&self) -> Self::Protobuf {
        Self::Protobuf {
            fractional_amount: Some(self.fractional_amount.to_protobuf()),
...
impl FromProtobuf for RoyaltyFee {
    ...
    fn from_protobuf(pb: Self::Protobuf) -> crate::Result<Self> {
        Ok(Self {
            ...
            exchange_value_fraction: Fraction::from_protobuf(pb_getf!(pb, exchange_value_fraction)?)?,
        })
    }
}
...
impl ToProtobuf for RoyaltyFee {
    ...
    fn to_protobuf(&self) -> Self::Protobuf {
        Self::Protobuf {
            ...
            exchange_value_fraction: Some(self.exchange_value_fraction.to_protobuf()),
        }
    }
}
...
mod tests {
    ...
    fn custom_fee_can_convert_to_protobuf() -> anyhow::Result<()> {
        let custom_fee = CustomFee {
            ...
            fee: Fee::FixedFee(
                FixedFee {
                    denominating_token_id: TokenId::from(2),
                    amount: 1000
                }
            )
        };
        ...
        assert_eq!(Some(custom_fee.fee_collector_account_id.to_protobuf()), custom_fee_proto.fee_collector_account_id);
    ...
    fn fee_can_convert_to_protobuf() -> anyhow::Result<()> {
        let amount = 1000;
        let fee = Fee::FixedFee(FixedFee {
            amount,
            denominating_token_id: TokenId::from(1),
        });
    ...
    fn royalty_fee_can_convert_to_protobuf() -> anyhow::Result<()> {
        ...
        let royalty_fee = RoyaltyFee {
            fallback_fee: fallback_fee.clone(),
        ...
        assert_eq!(royalty_fee_proto.exchange_value_fraction, Some(exchange_value_fraction.to_protobuf()));
    ...
    fn royalty_fee_can_be_created_from_protobuf() -> anyhow::Result<()> {
        ...
        let fallback_fee = services::FixedFee { denominating_token_id: Some(TokenId::from(1).to_protobuf()), amount };
