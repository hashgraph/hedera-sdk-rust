...
impl TransactionData for AnyTransactionData {
    ...
    fn chunk_data(&self) -> Option<&super::ChunkData> {
        match self {
            ...
            AnyTransactionData::AccountDelete(_) => todo!(),
            AnyTransactionData::AccountAllowanceApprove(_) => todo!(),
            AnyTransactionData::AccountAllowanceDelete(_) => todo!(),
            AnyTransactionData::ContractCreate(_) => todo!(),
            AnyTransactionData::ContractUpdate(_) => todo!(),
            AnyTransactionData::ContractDelete(_) => todo!(),
            AnyTransactionData::ContractExecute(_) => todo!(),
            AnyTransactionData::Transfer(_) => todo!(),
            AnyTransactionData::TopicCreate(_) => todo!(),
            AnyTransactionData::TopicUpdate(_) => todo!(),
            AnyTransactionData::TopicDelete(_) => todo!(),
            AnyTransactionData::TopicMessageSubmit(_) => todo!(),
            AnyTransactionData::FileAppend(_) => todo!(),
            AnyTransactionData::FileCreate(_) => todo!(),
            AnyTransactionData::FileUpdate(_) => todo!(),
            AnyTransactionData::FileDelete(_) => todo!(),
            AnyTransactionData::TokenAssociate(_) => todo!(),
            AnyTransactionData::TokenBurn(_) => todo!(),
            AnyTransactionData::TokenCreate(_) => todo!(),
            AnyTransactionData::TokenDelete(_) => todo!(),
            AnyTransactionData::TokenDissociate(_) => todo!(),
            AnyTransactionData::TokenFeeScheduleUpdate(_) => todo!(),
            AnyTransactionData::TokenFreeze(_) => todo!(),
            AnyTransactionData::TokenGrantKyc(_) => todo!(),
            AnyTransactionData::TokenMint(_) => todo!(),
            AnyTransactionData::TokenPause(_) => todo!(),
            AnyTransactionData::TokenRevokeKyc(_) => todo!(),
            AnyTransactionData::TokenUnfreeze(_) => todo!(),
            AnyTransactionData::TokenUnpause(_) => todo!(),
            AnyTransactionData::TokenUpdate(_) => todo!(),
            AnyTransactionData::TokenWipe(_) => todo!(),
            AnyTransactionData::SystemDelete(_) => todo!(),
            AnyTransactionData::SystemUndelete(_) => todo!(),
            AnyTransactionData::Freeze(_) => todo!(),
            AnyTransactionData::ScheduleCreate(_) => todo!(),
            AnyTransactionData::ScheduleSign(_) => todo!(),
            AnyTransactionData::ScheduleDelete(_) => todo!(),
            AnyTransactionData::Ethereum(_) => todo!(),
        }
    }
